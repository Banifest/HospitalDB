...
MAN_FIO = ["{0} {1}".format(random.choice(MAN_NAMES), random.choice(SURNAMES)) for x in range(0, 40000)]

WOMAN_FIO = ["{0} {1}".format(random.choice(WOMAN_NAMES), random.choice(SURNAMES)) for x in range(0, 40000)]
...
#
# for x in range(100):
#     file.write("""EXEC [add_doctor] '{0}', '{1}', '{2}', '{3}', '{4}';\n
#       GO\n""".format(
#         'doctor' + str(x), 220000, str(counter) + x, 123, '{0}-{1}-{2}'.format(
#             random.randint(1, 28), random.randint(1, 12), random.randint(1900, 2017)
#         )
#     ))

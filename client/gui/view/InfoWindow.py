...
class InfoWindow(CloseInterface):
    def __init__(self, controller):
        ...
        self.drag_id_text_box.valueChanged.connect(self._controller.set_id_drag)
        ...
        self.get_work_time_zip_text_box.valueChanged.connect(self._controller.set_get_time_zip)
